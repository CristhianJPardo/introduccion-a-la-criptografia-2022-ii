...
import { permutationEncrypt } from './PermutationFunctions';

export const PermutationEncrypt = (props) => {
    ...
    const changeEncryptedText = (text) => {
        let encryptedText = permutationEncrypt(text, Array.from(nState.toString()).map(Number))
    ...
    return (
        ...
        <Paper sx={{
            ...
            <Typography
                variant='h5'
                sx={{ mt: 2 }}
            >Permutation: Encrypt</Typography>
